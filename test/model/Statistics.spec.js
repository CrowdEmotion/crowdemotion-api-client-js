...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdemotionApiClientJs.Statistics();
  });
  ...
  describe('Statistics', function() {
    it('should create an instance of Statistics', function() {
      ...
      //var instane = new CrowdemotionApiClientJs.Statistics();
      //expect(instance).to.be.a(CrowdemotionApiClientJs.Statistics);
    });
