...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdemotionApiClientJs.Timeseries();
  });
  ...
  describe('Timeseries', function() {
    it('should create an instance of Timeseries', function() {
      ...
      //var instane = new CrowdemotionApiClientJs.Timeseries();
      //expect(instance).to.be.a(CrowdemotionApiClientJs.Timeseries);
    });
