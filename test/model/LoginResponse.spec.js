...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdemotionApiClientJs.LoginResponse();
  });
  ...
  describe('LoginResponse', function() {
    it('should create an instance of LoginResponse', function() {
      ...
      //var instane = new CrowdemotionApiClientJs.LoginResponse();
      //expect(instance).to.be.a(CrowdemotionApiClientJs.LoginResponse);
    });
