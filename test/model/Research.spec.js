...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrowdemotionApiClientJs.Research();
  });
  ...
  describe('Research', function() {
    it('should create an instance of Research', function() {
      // uncomment below and update the code to test Research
      //var instane = new CrowdemotionApiClientJs.Research();
      //expect(instance).to.be.a(CrowdemotionApiClientJs.Research);
    });
